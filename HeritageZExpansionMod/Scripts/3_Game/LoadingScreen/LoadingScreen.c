 ...
 * Edit HeritageZ Community Mod, Bigi
 *
 * Custom Loading Screen System inspired by Community-Loading-Screen by Salutesh.
 */
...
{
	bool ShowLogo = true;
	string LogoPath = "HeritageZExpansionMod/GUI/heritage_logo.edds";
	bool RandomizeBackgounds = true;
	int LoadingBarColor = ARGB(255, 228, 184, 65);
	bool UseCustomHints = true;
	string HintIconPath = "HeritageZExpansionMod/GUI/icons/info.edds";
	...
	void CustomLoadingScreenData()
	{
		...
		JsonFileLoader<array<ref CustomLoadingScreenBackground>>.JsonLoadFile("HeritageZExpansionMod/Scripts/Data/LoadingImages.json", m_ExBackgrounds);
	}
};

modded class UiHintPanel
{
	protected const string 	m_ExDataPath = "HeritageZExpansionMod/Scripts/Data/Hints.json"; 
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_ExHintIcon = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("HeritageZExpansionMod/GUI/layouts/hint_icon.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.ShowLogo && m_ExCustomLoadingScreenData.LogoPath != string.Empty)
		{
			...
			m_ImageLogoCorner = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("HeritageZExpansionMod/GUI/layouts/logo.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.LoadingBarColor != 0)
		{
			...
			m_ProgressLoading = ProgressBarWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("HeritageZExpansionMod/GUI/layouts/loading_bar.layout", m_ExPanelWidget));
